...
import pysmartmeter
from pysmartmeter.cli_dev import PACKAGE_ROOT, app
...
def install():
    """
    Install requirements and 'pysmartmeter' via pip as editable.
    """
...
def publish():
    ...
    publish_package(module=pysmartmeter, package_path=PACKAGE_ROOT)
